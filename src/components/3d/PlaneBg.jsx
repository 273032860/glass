...
import { warp } from "./Bgshader"
import { uv, vec2 } from "three/tsl"
import { Hud, OrthographicCamera } from "@react-three/drei"
import { limestone } from "./Limestone"
import { sun } from "./BgSun"
import ShaderToyNode from "./ShaderToy"
...
export const PlaneBg = () => {
  ...
  shaderToy1Node.parse( b );
  return (
  
      <mesh onClick={()=>{console.log('222')}}>
        <planeGeometry args={[viewport.width, viewport.height]} />
        <meshBasicNodeMaterial transparent opacity={1} colorNode={shaderToy1Node}  />
      </mesh>
